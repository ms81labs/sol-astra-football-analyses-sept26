...
import GeometryZoomCutWritePanel from './components/GeometryZoomCutWritePanel';
import MetricsSpecWritePanel from './components/MetricsSpecWritePanel';
import WorkerImportWritePanel from './components/WorkerImportWritePanel';
import AssistanceGroundWritePanel from './components/AssistanceGroundWritePanel';
import AssistanceSelectEvidenceWritePanel from './components/AssistanceSelectEvidenceWritePanel';
import MetricsLegacyZeroWritePanel from './components/MetricsLegacyZeroWritePanel';
...
import DependencyRegisterWritePanel from './components/DependencyRegisterWritePanel';
import GroundContactWritePanel from './components/GroundContactWritePanel';
import ReleaseDossierWritePanel from './components/ReleaseDossierWritePanel';
    ...
    <div className="min-h-screen bg-slate-900 text-slate-200 p-6 font-sans">
      ...
      <main className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl shadow-lg border border-slate-700 p-4 flex flex-col" style={{ maxHeight: '85vh' }}>
          ...
          <div className="mb-3 shrink-0">
            <GeometryZoomCutWritePanel />
          </div>
          <div className="mb-3 shrink-0">
            <MetricsSpecWritePanel />
          </div>
          <div className="mb-3 shrink-0">
            <WorkerImportWritePanel />
          </div>
          <div className="mb-3 shrink-0">
            <AssistanceGroundWritePanel />
          </div>
          <div className="mb-3 shrink-0">
            <AssistanceSelectEvidenceWritePanel />
          </div>
          <div className="mb-3 shrink-0">
            <MetricsLegacyZeroWritePanel />
          </div>
          <div className="mb-3 shrink-0">
            <MetricsPossessionStatesWritePanel />
          </div>
          <div className="mb-3 shrink-0">
            <ReportsTemplateWritePanel />
          </div>
          <div className="mb-3 shrink-0">
          ...
          <div className="mb-3 shrink-0">
            <DecodeChallengersWritePanel />
          </div>
          <div className="mb-3 shrink-0">
            <GpuDefaultFlagWritePanel />
          </div>
          <div className="mb-3 shrink-0">
          ...
          <div className="mb-3 shrink-0">
            <ChallengerAdaptersWritePanel />
          </div>
          <div className="mb-3 shrink-0">
            <StalePermissionsWritePanel />
          </div>
          <div className="mb-3 shrink-0">
          ...
          <div className="mb-3 shrink-0">
            <DependencyRegisterWritePanel />
          </div>
          <div className="mb-3 shrink-0">
            <GroundContactWritePanel />
          </div>
          <div className="mb-3 shrink-0">
            <ReleaseDossierWritePanel />
          </div>
          <div className="mb-3 shrink-0">
            <LeftoverHeatmapWritePanel />
          </div>
          <div className="mb-3 shrink-0">
            <LeftoverSearchWritePanel />
          </div>
          <div className="mb-3 shrink-0">
          ...
          <div className="mb-3 shrink-0">
            <LeftoverTrainingAdmitWritePanel />
          </div>
          <div className="mb-3 shrink-0">
            <LeftoverMatchLibraryWritePanel />
          </div>
          <div className="mb-3 shrink-0">
