...
DEFAULT_OUTPUT_DIR_NAME = "v7_2_promotion_readiness_validation_v1"
DEFAULT_SUITE_NAME = "frozen-viable-baseline-slice-suite"

BLOCKER_MISSING_TRUTH = "v7_2_promotion_readiness_missing_upstream_truth"
BLOCKER_CHECKPOINT = "v7_2_promotion_checkpoint_contract_failure"
BLOCKER_EXPORT = "v7_2_promotion_export_contract_failure"
BLOCKER_BOUNDED = "v7_2_promotion_bounded_metric_failure"
BLOCKER_GUARDRAIL = "v7_2_promotion_guardrail_metric_failure"
BLOCKER_PIPELINE_FLOOD = "v7_2_promotion_full_pipeline_flood_regression"
BLOCKER_POSITIVE_RECALL = "v7_2_promotion_positive_recall_insufficient"
BLOCKER_PIPELINE_CONTRACT = "v7_2_promotion_pipeline_contract_failure"

NEXT_FULL_PIPELINE = "v7_2_full_pipeline_non_promotion_eval"
NEXT_RUNTIME_INTEGRATION = "v7_2_runtime_integration_fix"
NEXT_POSITIVE_DIVERSITY = "v7_2_positive_diversity_refresh"
NEXT_HARD_NEGATIVE = "v7_2_hard_negative_expansion"
NEXT_TRAINING_DEBUG = "v7_2_training_signal_regression_debug"
NEXT_CONTROLLED_SOURCE_ROBUSTNESS = "promoted_v7_2_source_robustness_validation"
NEXT_RUNTIME_DEFAULT = "v7_2_runtime_default_change_validation"
...
def _truth_paths(candidate_root: Path, storage_root: Path) -> dict[str, Path]:
    return {
        "export": candidate_root / "v7_2_export_label_overlay_audit_v1" / "v7_2_label_overlay_audit.json",
        "bounded": candidate_root / "v7_2_bounded_retrain_v1" / "v7_2_bounded_retrain_summary.json",
        "guardrail": candidate_root
        / "v7_2_crop_probe_precision_guardrail_audit_v1"
        / "v7_2_crop_probe_precision_guardrail_summary.json",
    ...
    return [
        {
            ...
            "successCriteria": [
                "v7.2 export, bounded, guardrail, and full-pipeline truth exist",
...
def _source_blockers(suite: dict[str, Any] | None) -> list[str]:
    if suite is None:
...
def _classify(gate_audit: dict[str, Any], missing_inputs: list[str]) -> tuple[str | None, str, bool, str]:
    if missing_inputs:
        return (
            ...
            NEXT_FULL_PIPELINE,
            False,
            "Promotion readiness cannot run because one or more generated v7.2 truth artifacts are missing.",
        )
    ...
    if not bounded["localCheckpointExists"] or not bounded["checkpointContractPassed"]:
        return (
            ...
            NEXT_TRAINING_DEBUG,
            False,
            "No verified local v7.2 trained checkpoint is available for promotion readiness.",
        )
    if not gate_audit["export"]["exportGatePassed"]:
        return (
            ...
            False,
            "The v7.2 physical export contract no longer clears promotion-readiness requirements.",
        )
    if not bounded["boundedGatePassed"]:
        return (
            ...
            NEXT_TRAINING_DEBUG,
            False,
            "The v7.2 bounded retrain metrics do not clear promotion-readiness requirements.",
        )
    if not gate_audit["guardrail"]["guardrailGatePassed"]:
        return (
            ...
            NEXT_HARD_NEGATIVE,
            False,
            "The v7.2 crop precision guardrail no longer clears promotion-readiness requirements.",
        )
    if (
        ...
        return (
            ...
            False,
            "The full-pipeline gate shows a v7.2 flood/artifact regression.",
        )
    ...
    return (
        ...
        "",
        True,
        "v7.2 cleared controlled promotion-readiness gates from generated export, bounded, guardrail, and full-pipeline truth.",
    )
...
def _markdown_summary(summary: dict[str, Any]) -> str:
    lines = [
        "# V7.2 Promotion Readiness Validation",
        "",
...
def run_v7_2_promotion_readiness_validation(
    *,
    ...
    runtime_blockers = _source_blockers(suite)
    ...
    summary: dict[str, Any] = {
        ...
        if not promotion_validated
            ...
            "v7.2 is validated for controlled promotion use. Runtime-default mutation was evaluated separately and "
            + (
        ...
        "sourceRobustnessOutcome": suite.get("sourceRobustnessOutcome") if suite else None,
        "suiteVerdict": suite.get("suiteVerdict") if suite else None,
    ...
    controlled_registry_entry = {
        ...
        "runtimeContract": runtime_contract,
        "evidence": {
            "promotionReadinessSummaryPath": str(output_root / "v7_2_promotion_readiness_summary.json"),
    ...
    suite_promotion_payload = {
        **controlled_registry_entry,
        "batchOutcomeAnalysis": {
            "batchGoal": "Validate v7.2 for controlled promotion readiness from generated truth.",
            "goalAchieved": promotion_validated,
            "roadmapAdvanceAllowed": True,
            "promotionValidated": promotion_validated,
            "promotedForControlledRuns": promotion_validated,
    ...
    _write_json(output_root / "v7_2_promotion_readiness_summary.json", summary)
    ...
    suite_readiness_path = _suite_root(storage_root) / "v7_2_detector_candidate_promotion_readiness.json"
    _write_json(
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Validate v7.2 controlled promotion readiness from generated truth.")
...
def main() -> None:
    ...
    payload = run_v7_2_promotion_readiness_validation(
