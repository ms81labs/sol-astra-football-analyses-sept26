...
DEFAULT_CHANGE_DIR_NAME = "v7_2_runtime_default_change_validation_v1"
DEFAULT_OUTPUT_DIR_NAME = "v7_2_post_runtime_default_source_robustness_validation_v1"
PROFILE_NAME = "source_robustness_shadow_v7_2_default_path_inboard_recovery_v1"

BLOCKER_SOURCE_TRUTH_MISSING = "v7_2_post_default_source_truth_missing"
BLOCKER_REGISTRY = "v7_2_post_default_registry_contract_gap"
BLOCKER_FAILING_SOURCE_RESURRECTED = "v7_2_post_default_failing_source_not_viable_resurrected"
BLOCKER_SOURCE_REGRESSION = "v7_2_post_default_source_robustness_regression"

NEXT_SOURCE_REGENERATION = "v7_2_post_default_source_robustness_regeneration"
NEXT_REGISTRY_REPAIR = "v7_2_post_default_registry_contract_repair"
NEXT_SOURCE_DEBUG = "v7_2_post_default_source_robustness_regression_debug"
NEXT_CLOSEOUT = "v7_2_runtime_default_rollout_closeout"
    ...
    return [
        {
            ...
            "successCriteria": [
                "active runtime registry points to touchline_detector_candidate_v7 / v7.2",
    ...
    *,
    ...
    if not registry_audit["activeRuntimeDefaultRegistryPassed"]:
        return (
            ...
            False,
            "The active runtime registry is not a validated v7.2 default-runtime entry.",
        )
    ...
    return (
        ...
        NEXT_CLOSEOUT,
        True,
        "The active v7.2 runtime default preserves source robustness and the old failing_source_not_viable blocker remains cleared.",
    )
    ...
    updated.update(
        {
            ...
            "postRuntimeDefaultSourceRobustnessValidationBatchName": "v7_2_post_runtime_default_source_robustness_validation",
...
def _markdown_summary(summary: dict[str, Any]) -> str:
    return "\n".join(
        [
            "# V7.2 Post Runtime Default Source Robustness Validation",
            "",
...
def run_v7_2_post_runtime_default_source_robustness_validation(
    *,
    ...
    _write_json(
        output_root / "runtime_registry_post_validation_audit.json",
    ...
    _write_json(
        ...
        {
            "summary": summary,
            "activeRuntimeDefaultRegistryAudit": registry_audit,
            "postMutationSourceRobustnessGateAudit": source_audit,
            "failingSourceBlockerResurrectionAudit": resurrection_audit,
        },
    )
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Validate v7.2 source robustness after runtime-default mutation.")
...
def main() -> None:
    ...
    payload = run_v7_2_post_runtime_default_source_robustness_validation(
