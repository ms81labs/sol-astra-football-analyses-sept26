...
DEFAULT_INPUT_BATCH_NAME = "v7_2_export_label_overlay_audit_v1"
DEFAULT_OUTPUT_DIR_NAME = "v7_2_bounded_retrain_v1"
DEFAULT_EXPORT_PREVIEW_DIR_NAME = "v7_2_export_preview"
...
BLOCKER_TRAIN_FAILED = "v7_2_bounded_train_failed_to_complete"
BLOCKER_CHECKPOINT = "v7_2_bounded_checkpoint_contract_failure"
BLOCKER_LABELS = "v7_2_bounded_label_ingestion_failure"
BLOCKER_TRAIN_POSITIVE = "v7_2_bounded_positive_localization_failure"
BLOCKER_VAL_RECALL = "v7_2_bounded_validation_recall_insufficient"
BLOCKER_NEGATIVE_FLOOD = "v7_2_bounded_negative_false_positive_flood"
BLOCKER_CANARY_FLOOD = "v7_2_bounded_canary_flood"
BLOCKER_TOP_LEFT = "v7_2_bounded_top_left_artifact_regression"
BLOCKER_GIANT = "v7_2_bounded_giant_box_regression"
BLOCKER_CONFIDENCE = "v7_2_bounded_confidence_still_weak"
BLOCKER_MISSING = "v7_2_bounded_overlay_artifacts_missing"

NEXT_GUARDRAIL = "v7_2_crop_probe_precision_guardrail_audit"
...
NEXT_SIGNAL_DEBUG = "v7_2_training_signal_regression_debug"
...
def _training_recipe(*, device: str, epochs: int) -> dict[str, Any]:
    ...
    recipe["trainingBatchName"] = "v7_2_bounded_retrain"
    recipe["sourceExportBatchName"] = DEFAULT_INPUT_BATCH_NAME
    return recipe


def _run_runpod_training_v7_2(
    *,
    dataset_root: Path,
    data_yaml_path: Path,
    output_root: Path,
    ...
    try:
        session = runpod_session.create_runpod_session(
            clip_path=None,
            pod_name=f"{DEFAULT_CANDIDATE_NAME}-v7-2-bounded-retrain",
            gpu_id=None,
        )
        remote_dataset_root = (
...
def _classify_selected(selected: dict[str, Any]) -> tuple[str | None, str, bool, str]:
    if selected["boundedTrainPositiveLocalizationHitRate"] < PASS_MIN_TRAIN_LOCALIZATION_RATE:
        return (
            ...
            NEXT_SIGNAL_DEBUG,
            False,
            "Bounded crop training did not localize enough training positives; stay in training/config debug.",
        )
    ...
    return (
        ...
        NEXT_GUARDRAIL,
        True,
        "Bounded crop retrain passed. Advance to v7.2 crop probe precision guardrail audit; do not promote.",
    )
