...
def create_match_detail_router(
    ...
    def post_match_report(match: Annotated[MatchRecord, Depends(require_match)], payload: dict | None = None) -> dict:
        body = payload or {}
    ...
    def get_match_heatmap(match: Annotated[MatchRecord, Depends(require_match)], generationId: str | None = None) -> dict:
    ...
    def get_match_players(match: Annotated[MatchRecord, Depends(require_match)], generationId: str | None = None) -> dict:
        try:
    ...
    def get_match_ownership(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        try:
    ...
    def get_match_package(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        try:
    ...
    def get_match_incident_geometry(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        try:
    ...
    def match_setup(match: Annotated[MatchRecord, Depends(require_match)], generationId: str | None = None) -> dict:
    ...
    def match_rates(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        return storage.four_rates_for_match(match.id)
    
    @router.get("/api/matches/{match_id}/metrics")
    def get_match_metrics(match: Annotated[MatchRecord, Depends(require_match)], generationId: str | None = None) -> dict:
        try:
    ...
    def inspect_stored_metric(metric: str, match: Annotated[MatchRecord, Depends(require_match)], generationId: str | None = None) -> dict:
        try:
    ...
    def get_match_incident_package(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        return storage.incident_package_for_match(match.id)
    
    @router.get("/api/matches/{match_id}/clock")
    def get_match_clock(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        try:
    ...
    def get_match_incident_review(match: Annotated[MatchRecord, Depends(require_match)], generationId: str | None = None) -> dict:
        try:
    ...
    def get_match_privacy(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        return storage.dpia_for_match(match.id)
    
    @router.get("/api/matches/{match_id}/setup/preview")
    def get_match_setup_preview(match: Annotated[MatchRecord, Depends(require_match)], generationId: str | None = None) -> dict:
    ...
    def commit_match_calibration(match: Annotated[MatchRecord, Depends(require_match)], payload: dict | None = None) -> dict:
        return storage.commit_calibration_for_match(match.id, payload or {})
    
    @router.post("/api/matches/{match_id}/recompute")
    def post_match_recompute(match: Annotated[MatchRecord, Depends(require_match)], payload: dict | None = None) -> dict:
        body = payload or {}
    ...
    def post_match_recompute_execute(match: Annotated[MatchRecord, Depends(require_match)], payload: dict | None = None) -> dict:
        body = payload or {}
    ...
    def get_match_promotion(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        return storage.promotion_receipt_for_match(match.id)
    
    @router.get("/api/matches/{match_id}/quality")
    def get_match_quality(match: Annotated[MatchRecord, Depends(require_match)], generationId: str | None = None) -> dict:
    ...
    def get_match_identity(match: Annotated[MatchRecord, Depends(require_match)], generationId: str | None = None) -> dict:
    ...
    def post_match_identity_repair(match: Annotated[MatchRecord, Depends(require_match)], payload: dict | None = None) -> dict:
        return storage.repair_identity_for_match(match.id, payload)
    
    @router.post("/api/matches/{match_id}/identity/promote")
    def post_match_identity_promote(match: Annotated[MatchRecord, Depends(require_match)], payload: dict | None = None) -> dict:
        return storage.promote_identity_for_match(match.id, payload)
    
    @router.get("/api/matches/{match_id}/history")
    def get_match_history(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        return storage.history_for_match(match.id)
    
    @router.get("/api/matches/{match_id}/cache")
    def get_match_cache(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        return storage.cache_identity_for_match(match.id)
    
    @router.get("/api/matches/{match_id}/records/migrate")
    def get_match_legacy_migrate(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        return storage.migrate_legacy_for_match(match.id)
    
    @router.get("/api/matches/{match_id}/attack-direction")
    def get_match_attack_direction(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
    ...
    def post_match_attack_direction(match: Annotated[MatchRecord, Depends(require_match)], payload: dict | None = None) -> dict:
        body = payload or {}
    ...
    def get_match_calibration(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        return storage.calibration_for_match(match.id)
    
    @router.post("/api/matches/{match_id}/calibration")
    def post_match_calibration(match: Annotated[MatchRecord, Depends(require_match)], payload: dict | None = None) -> dict:
        return storage.calibration_for_match(match.id, payload)
    
    @router.get("/api/matches/{match_id}/formation")
    def get_match_formation(match: Annotated[MatchRecord, Depends(require_match)], generationId: str | None = None) -> dict:
    ...
    def get_match_event_partition(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        return storage.partition_events_for_match(match.id)
    
    @router.get("/api/matches/{match_id}/reports/provenance")
    def get_match_report_provenance(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        return storage.provenance_for_match(match.id)
    
    @router.get("/api/matches/{match_id}/reports/coverage")
    def get_match_report_coverage(match: Annotated[MatchRecord, Depends(require_match)], generationId: str | None = None) -> dict:
    ...
    def get_match_shot_quality(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        return storage.shot_quality_for_match(match.id)
    
    @router.get("/api/matches/{match_id}/media/proxy")
    def get_match_proxy(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        return storage.proxy_assets_for_match(match.id)
    
    @router.get("/api/matches/{match_id}/edits")
    def get_match_edits(match: Annotated[MatchRecord, Depends(require_match)], generationId: str | None = None) -> dict:
        return storage.edit_list_for_match(match.id, generation_id=generationId)
    
    @router.post("/api/matches/{match_id}/edits/render")
    def post_match_edit_render(match: Annotated[MatchRecord, Depends(require_match)], payload: dict | None = None) -> dict:
        body = payload or {}
    ...
    def get_match_derived_distance(match: Annotated[MatchRecord, Depends(require_match)], generationId: str | None = None) -> dict:
    ...
    def get_match_shot_features(match: Annotated[MatchRecord, Depends(require_match)]) -> dict:
        return storage.shot_features_for_match(match.id)
    
    @router.post("/api/matches/{match_id}/recovery/import")
    def post_match_corrupted_import(match: Annotated[MatchRecord, Depends(require_match)], payload: dict | None = None) -> dict:
        body = payload or {}
    ...
    def post_match_assistance_report(match: Annotated[MatchRecord, Depends(require_match)], payload: dict | None = None) -> dict:
        body = payload or {}
        claimed = body.get("claimedEvidenceIds")
        try:
            return storage.assemble_match_report(
    ...
    def analyze_match(analysis_type: str, match: Annotated[MatchRecord, Depends(require_match)], body: dict | None = None) -> dict:
        match_id = match.id
        body = body or {}
    ...
    def update_match_config(match: Annotated[MatchRecord, Depends(require_match)], payload: dict | None = None) -> dict:
